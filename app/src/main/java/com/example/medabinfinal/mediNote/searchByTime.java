...
public class searchByTime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medinote_search_by_time);

        //initialize view
        recyclerView = findViewById(R.id.recyclerSearchTime);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        searchBar = findViewById(R.id.search_bar_medinote_time);
    ...
    private void startSearch(String time) {
        searchAdapter = new adapter(this,noteDatabase.searchByTime(time));
        recyclerView.setAdapter(searchAdapter);
    ...
    private void loadSuggestedList() {
        ...
        suggestList = noteDatabase.getTimes();

...
public class searchByTitle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medinote_search_by_title);

        //initialize view
        recyclerView = findViewById(R.id.recyclerSearchTitle);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);

        searchBar = findViewById(R.id.search_bar_medinote_title);
    ...
    private void startSearch(String text) {
        searchAdapter = new adapter(this,noteDatabase.searchByTitle(text));
        recyclerView.setAdapter(searchAdapter);
    ...
    private void loadSuggestedList() {
        ...
        suggestList = noteDatabase.getTitles();

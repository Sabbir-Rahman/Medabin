...
public class medicineReminderAdd extends AppCompatActivity {
    ...
    EditText name,count,time1,time2,time3;
    int time1Hour,time1minute,time2Hour,time2minute,time3Hour,time3minute;
    String time1Databse,time2Databse,time3Databse,amPm1,amPm2,amPm3;
    int time1HourDatabse,time1MinuteDatabse,time2HourDatabse,time2MinuteDatabse,time3HourDatabse,time3MinuteDatabse;
    Button submit;
    Switch isTaken;
    int countMedicine,remainMedicine;
